...
function ContactUsSection() {
  return (
   ...
   {/* <div className='w-5 h-5 bg-black' ></div> */}
    <div className='ml-auto mr-auto max-w-sm h-[400px] flex justify-center items-center'>
      <EmailjsComponent />
    </div>
    <div className=' ml-auto mr-auto max-w-[500px] h-[350px] relative flex justify-center items-center'>
      <iframe 
